        ...
        <header>
            <div className="nav wrap">
                ...
                <form onSubmit={handleSearch}>
                    <input type="text" required placeholder="Enter your search" value={search}
                        onChange={e => setSearch(e.target.value)} disabled={pathname !== '/'} />
                ...
                <div className="row">
                    <button className="prev" onClick={() => handlePagination(page - 1)}
                        disabled={(pathname !== '/') || isLoading || (page === 1)}>
                        <i className="fas fa-chevron-left" />
                    </button>
                    <span>{page}</span>
                    <button className="next" onClick={() => handlePagination(page + 1)}
